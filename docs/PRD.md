...
```
               ...
               │         ▼
               │    ┌──────────────┐
               │    │ Investigating│ ←── 分析师/AI进行调查
               │    └──┬───────┬───┘
               │       │       │
               │       │       │ 需要响应
               │       │       ▼
               │       │  ┌──────────┐
               │       │  │Responding│ ←── 执行Playbook/手动处置
               │       │  └────┬─────┘
               │       │       │
               │       ▼       ▼
               │    ┌──────────┐
...
2026 Q3                    Q4                    2027 Q1                   Q2
  ...
  │                         │                       │                       │
  │  核心框架               │  自动化响应            │  智能增强              │  平台化
  │  Case CRUD              │  Playbook引擎          │  威胁情报集成          │  Web前端
  │  基础告警接入           │  响应动作库            │  知识沉淀              │  多租户
  │  AI研判Agent            │  分级审批              │  合规审计              │  API开放平台
  │  CLI/TUI                │                       │                       │
```
